...
<div class="rounded sm:px-1 sm:px-1 sm:bg-gray-100">
    ...
    <tbody class="divide-y divide-gray-200">
            <tr>
            <td class="px-6 py-4 whitespace-nowrap">190502100</td>
            <td class="px-6 py-4 whitespace-nowrap"> Ilham Bahamut</td>
            <td class="px-6 py-4 whitespace-nowrap">
            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                  Active
            </td>
            <td class="px-6 py-4 whitespace-nowrap">Guru Honor</td>
            <td class="px-6 py-4 whitespace-nowrap" >
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Lat-laravel\resources\views/admin/dataguru.blade.php ENDPATH**/ ?>